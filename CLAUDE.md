...
1. **`regime`** — 5yr backtest of all 5 active strategies across 3 regimes (uptrend/choppy/downtrend). Writes `reports/th_regime_latest.md` and saves regime labels to `regime_labels` DB table.
...
5 active strategies: `pivot_breakout`, `pullback_buy`, `reversal`, `bb_squeeze`, `ma_cross`.
